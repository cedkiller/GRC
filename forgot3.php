...
<body>
    ...
    <div style="display: flex; justify-content: center; margin-top: 330px;" class="hidden_animation">
        <div class="div20">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    try {
                        ...
                        $mail->Body = '<div>
                            ...
                            <br>
                            <a href="http://localhost/GRC/reset3.php" style="text-decoration: none;"><button style = "cursor: pointer;
                            height: 40px;
                            width: 250px;
                            padding: 9px 25px;
                            background: #f50c0c;
                        ...
                        echo "<script>swal('Error!', 'Failed to send the email. Please try again.', 'error');</script>";
                    }
                }
                ?>
            </div>
